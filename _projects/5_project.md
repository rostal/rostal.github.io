...
One Health data collected on different populations often use different methods and later need to be cleaned and integrated in a standardized way. To do this, we developed an R package, [open-rvfcast](https://github.com/ecohealthalliance/open-rvfcast). 
